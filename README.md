...
```sh
PYTHONPATH=platform/btl-measure python3.13 -m btl_measure.cli validate evaluation.json
PYTHONPATH=platform/btl-measure python3.13 -m btl_measure.cli compare baseline.json candidate.json
```
